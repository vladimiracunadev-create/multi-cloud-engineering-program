const CACHE = "multicloud-program-v2.1.0-r1";
...
const CORE = [
  "./", "./index.html", "./app.js?v=2.1.0-r1", "./catalog.json",
  "./manifest.webmanifest", "./assets/icon.svg", "./assets/class.css?v=2.1.0-r1",
  "./assets/class.js?v=2.1.0-r1"
];
