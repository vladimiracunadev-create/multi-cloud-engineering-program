...
> [← Clase anterior](../../part-07-infrastructure-as-code-configuration/087-estado-remoto-locking-cifrado-y-recuperacion/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../part-07-infrastructure-as-code-configuration/089-variables-outputs-locals-y-data-sources/README.md)
...
Comprender y aplicar **módulos, contratos, versiones y composición** dentro de una plataforma cloud realista,
