...
Comprender y aplicar **service discovery, malla y comunicación** dentro de una plataforma cloud realista,
...
5. **Entregar** `topologia-servicios` con evidencia, límites y criterio de reversión.
