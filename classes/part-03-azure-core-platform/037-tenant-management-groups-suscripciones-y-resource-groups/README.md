...
Comprender y aplicar **tenant, management groups, suscripciones y resource groups** dentro de una plataforma cloud realista,
...
5. **Entregar** `jerarquia-azure` con evidencia, límites y criterio de reversión.
