...
> [← 102 · Rolling, blue-green, canary y rollback](../../part-08-continuous-delivery-platform-engineering/102-rolling-blue-green-canary-y-rollback/README.md) · [Índice de la parte](../README.md) · [104 · Ambientes efímeros y promoción entre entornos →](../../part-08-continuous-delivery-platform-engineering/104-ambientes-efimeros-y-promocion-entre-entornos/README.md)
