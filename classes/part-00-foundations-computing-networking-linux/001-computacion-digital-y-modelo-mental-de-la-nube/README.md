...
Comprender y aplicar **computación digital y modelo mental de la nube** dentro de una plataforma cloud realista,
...
1. **Explicar** computación digital y modelo mental de la nube con vocabulario independiente del proveedor.
...
5. **Entregar** `mapa-de-componentes` con evidencia, límites y criterio de reversión.

## 🧩 Conceptos centrales

| Concepto | Comprensión verificable |
|---|---|
| `computación` | Define su papel en **computación digital y modelo mental de la nube** y cómo observarlo en un sistema real. |
| `digital` | Define su papel en **computación digital y modelo mental de la nube** y cómo observarlo en un sistema real. |
| `modelo` | Define su papel en **computación digital y modelo mental de la nube** y cómo observarlo en un sistema real. |
| `mental` | Define su papel en **computación digital y modelo mental de la nube** y cómo observarlo en un sistema real. |
| `nube` | Define su papel en **computación digital y modelo mental de la nube** y cómo observarlo en un sistema real. |
...
```mermaid
flowchart LR
    A["Necesidad y restricciones"] --> B["Diseño: Computación digital y modelo mental de la nube"]
...
Una plataforma de pedidos necesita aplicar **computación digital y modelo mental de la nube**. El equipo registra:
