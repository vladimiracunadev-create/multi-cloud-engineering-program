...
Comprender y aplicar **git, github y trabajo reproducible** dentro de una plataforma cloud realista,
...
1. **Explicar** git, github y trabajo reproducible con vocabulario independiente del proveedor.
...
5. **Entregar** `repositorio-reproducible` con evidencia, límites y criterio de reversión.

## 🧩 Conceptos centrales

| Concepto | Comprensión verificable |
|---|---|
| `git` | Define su papel en **git, github y trabajo reproducible** y cómo observarlo en un sistema real. |
| `github` | Define su papel en **git, github y trabajo reproducible** y cómo observarlo en un sistema real. |
| `trabajo` | Define su papel en **git, github y trabajo reproducible** y cómo observarlo en un sistema real. |
| `reproducible` | Define su papel en **git, github y trabajo reproducible** y cómo observarlo en un sistema real. |
...
```mermaid
flowchart LR
    A["Necesidad y restricciones"] --> B["Diseño: Git, GitHub y trabajo reproducible"]
...
Una plataforma de pedidos necesita aplicar **git, github y trabajo reproducible**. El equipo registra:
