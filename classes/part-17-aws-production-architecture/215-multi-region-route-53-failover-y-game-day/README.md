...
> [← 214 · Budgets, Cost Explorer, etiquetado y FinOps automatizado](../../part-17-aws-production-architecture/214-budgets-cost-explorer-etiquetado-y-finops-automatizado/README.md) · [Índice de la parte](../README.md) · [216 · Proyecto: CloudShop productivo en AWS →](../../part-17-aws-production-architecture/216-proyecto-cloudshop-productivo-en-aws/README.md)
...
```mermaid
flowchart TB
    O["objetivo de recuperación"] --> M{"modo"}
    M -->|"horas · barato"| M1["FRÍO\ndeclarado, apagado"]
    M -->|"minutos"| M2["CALIENTE\nmínimo encendido,\ndatos replicados"]
    M -->|"segundos · caro"| M3["ACTIVO-ACTIVO\ny hay que resolver\nla escritura"]
    M2 --> C["conmutación"]
    C --> C1["detección"]
    C --> C2["DECISIÓN\n← suele dominar"]
    C --> C3["redirección: TTL\n+ caché del cliente"]
    C --> C4["promoción de datos"]
    C --> C5["capacidad: escalado\ndesde casi cero"]
    C5 --> G["EJERCICIO DIRIGIDO"]
    G --> G1["hipótesis escrita"]
    G --> G2["ventana y forma\nde parar"]
    G --> G3["medir los cinco tramos"]
    G --> G4["y la VUELTA"]
```
...
|---|---|---|
| [← 214 · Budgets, Cost Explorer, etiquetado y FinOps automatizado](../../part-17-aws-production-architecture/214-budgets-cost-explorer-etiquetado-y-finops-automatizado/README.md) | [Parte 17](../README.md) · [Programa](../../README.md) | [216 · Proyecto: CloudShop productivo en AWS →](../../part-17-aws-production-architecture/216-proyecto-cloudshop-productivo-en-aws/README.md) |
