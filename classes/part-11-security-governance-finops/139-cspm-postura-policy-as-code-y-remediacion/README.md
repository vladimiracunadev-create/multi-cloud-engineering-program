...
Comprender y aplicar **cspm, postura, policy as code y remediación** dentro de una plataforma cloud realista,
...
|---|---|
| `cspm` | Define su papel en **cspm, postura, policy as code y remediación** y cómo observarlo en un sistema real. |
