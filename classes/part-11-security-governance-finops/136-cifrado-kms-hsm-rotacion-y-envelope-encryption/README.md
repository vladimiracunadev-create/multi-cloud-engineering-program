...
Comprender y aplicar **cifrado, kms, hsm, rotación y envelope encryption** dentro de una plataforma cloud realista,
...
5. **Entregar** `jerarquia-claves` con evidencia, límites y criterio de reversión.
