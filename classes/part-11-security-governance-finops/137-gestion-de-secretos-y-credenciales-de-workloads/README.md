...
> [← Clase anterior](../../part-11-security-governance-finops/136-cifrado-kms-hsm-rotacion-y-envelope-encryption/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../part-11-security-governance-finops/138-vulnerabilidades-imagenes-y-cadena-de-suministro/README.md)
...
Comprender y aplicar **gestión de secretos y credenciales de workloads** dentro de una plataforma cloud realista,
