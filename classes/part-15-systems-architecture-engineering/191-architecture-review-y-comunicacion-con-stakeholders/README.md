...
> [← Clase anterior](../../part-15-systems-architecture-engineering/190-adrs-fitness-functions-y-gobierno-de-decisiones/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../part-15-systems-architecture-engineering/192-proyecto-arquitectura-completa-de-cloudshop/README.md)
...
Comprender y aplicar **architecture review y comunicación con stakeholders** dentro de una plataforma cloud realista,
