...
> [← Clase anterior](../../part-04-gcp-core-platform/050-iam-service-accounts-y-workload-identity-federation/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../part-04-gcp-core-platform/052-compute-engine-managed-instance-groups-y-load-balancing/README.md)
...
Comprender y aplicar **vpc global, subredes regionales, firewall y cloud nat** dentro de una plataforma cloud realista,
