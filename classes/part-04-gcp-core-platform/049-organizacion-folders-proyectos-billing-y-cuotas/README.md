...
Comprender y aplicar **organización, folders, proyectos, billing y cuotas** dentro de una plataforma cloud realista,
...
5. **Entregar** `jerarquia-gcp` con evidencia, límites y criterio de reversión.
