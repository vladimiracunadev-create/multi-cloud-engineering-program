...
Comprender y aplicar **cloud sql, spanner, firestore y memorystore** dentro de una plataforma cloud realista,
...
Una plataforma de pedidos necesita aplicar **cloud sql, spanner, firestore y memorystore**. El equipo registra:
