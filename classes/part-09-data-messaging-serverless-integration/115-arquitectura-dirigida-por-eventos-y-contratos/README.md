...
> [← Clase anterior](../../part-09-data-messaging-serverless-integration/114-pub-sub-streams-particiones-y-orden/README.md) · [Índice de la parte](../README.md) · [Clase siguiente →](../../part-09-data-messaging-serverless-integration/116-sagas-outbox-idempotencia-y-deduplicacion/README.md)
...
Comprender y aplicar **arquitectura dirigida por eventos y contratos** dentro de una plataforma cloud realista,
