...
Comprender y aplicar **migración de una aplicación legacy a contenedores** dentro de una plataforma cloud realista,
...
5. **Entregar** `plan-modernizacion` con evidencia, límites y criterio de reversión.
